...
if (isset($_GET["tid"])) {
    ...
    $query = "SELECT t.tid, t.name AS trainee_name, t.temail, t.deptid, d.namedept, d.status as dept_status,
  t.superid, s.name AS supervisor_name, t.username, t.tpassword,
  t.phone_num, t.startdate, t.endate, t.courseofstudy, t.gender, t.status, t.uni, t.image_data, t.scase
  FROM trainee AS t
  ...
  WHERE t.tid = $tid";
    ...
    // Handle the case where 'tid' is not set (e.g., show an error message or redirect).
                                                ...
                                                <div class="col-md-10">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="value"><?= $trainee['namedept'] . '(' . ($trainee['dept_status'] == 1 ? 'Active' : 'Inactive') . ')'; ?></td>
                                                        </tr>
                                                        ...
                                                        <?php if ($status == 3 && !empty($trainee['scase'])) : ?>
                                                            <tr>
                                                                <td class="label">Special Case Explanation:</td>
                                                                <td class="value">
                                                                    <?php echo $trainee['scase']; ?>
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
