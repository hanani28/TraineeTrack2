...
<?php if (isset($successMessage)) : ?>
    ...
    <script>
        ...
        // You can customize the alert or use another method to show a success message
        // Example: You can replace the alert with a div to show a custom success message
        // document.getElementById('successMessage').innerText = "<?php echo $successMessage; ?>";
